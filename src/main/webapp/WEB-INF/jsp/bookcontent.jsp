...
<head>
    ...
    <script>
        ...
        function f2(e) {
            ...
            if (e.src === s+"/static/img/black.png") {
            ...
            if (e.src === s+"/static/img/green.png") {
            ...
            if (e.src === s+"/static/img/img_1.png") {
            ...
            function f3(e) {
            let s = e.src.substring(0,e.src.indexOf("/",e.src.indexOf("/",e.src.indexOf("/")+1)+1));
                if (e.src===s+"/static/img/fangsong.png"){
                    for (const x of document.getElementsByClassName("h")) {
                        $(x).css("font-family","仿宋");
                    };

                }
                if (e.src===s+"/static/img/kaiti.png"){
                    for (const x of document.getElementsByClassName("h")) {
                        $(x).css("font-family","楷体");
                    };
                }

                if (e.src===s+"/static/img/songti.png"){
                    for (const x of document.getElementsByClassName("h")) {
                        $(x).css("font-family","宋体");
                    };
                }

                if (e.src===s+"/static/img/yuanti.png"){
                    for (const x of document.getElementsByClassName("h")) {
...
<%--              设置div             --%>
    ...
    <div class="left_fw" style="margin-left: 85px">
        ...
        <div  id="d1" style="background: rgba(255,255,255,0.2) ;width: 200px;height: 100px;float:left; border-radius: 10px; display: none;
            ...
            背景：
            <img src="/static/img/black.png" width="30px",height="30px" onclick="f2(this)" style="border-radius:50%;overflow:hidden;">
            <img src="/static/img/green.png" width="30px",height="30px" onclick="f2(this)" style="border-radius:50%;overflow:hidden;">
            <img src="/static/img/img_1.png" width="30px",height="30px" onclick="f2(this)" style="border-radius:50%;overflow:hidden;">
            <img src="/static/img/tm.jpg" width="30px",height="30px" onclick="f2(this)" style="border-radius:50%;overflow:hidden;">

            <br>
            字体：
            <img src="/static/img/fangsong.png" width="30px" ,height="30px" onclick="f3(this)" style="border-radius:50%;overflow:hidden;">
            <img src="/static/img/kaiti.png" width="30px" ,height="30px" onclick="f3(this)" style="border-radius:50%;overflow:hidden;">
            <img src="/static/img/songti.png" width="30px" ,height="30px" onclick="f3(this)" style="border-radius:50%;overflow:hidden;">
            <img src="/static/img/yuanti.png" width="30px" ,height="30px" onclick="f3(this)" style="border-radius:50%;overflow:hidden;">
            <br>
            字体大小:
